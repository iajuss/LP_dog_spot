...
export const SPACES: Space[] = [
  // Centro
  {
    ...
    spaceType: "quintal",
    allowedUses: ["passeio", "treino", "socializacao"],
  ...
  },
  {
    ...
    spaceType: "terraco",
    allowedUses: ["passeio", "socializacao", "brincadeira"],
    dogSizes: ["pequeno", "medio", "grande"],
    maxDogs: 2,
  ...
  },
  {
    ...
    spaceType: "piscina",
    allowedUses: ["brincadeira", "socializacao", "passeio"],
    dogSizes: ["pequeno", "medio", "grande"],
    maxDogs: 3,
    availableSlots: ["manha", "tarde"],
    amenities: ["cercado", "agua", "sombra"],
  ...
  },
  {
    ...
    spaceType: "salao",
    allowedUses: ["treino", "brincadeira", "socializacao"],
    dogSizes: ["pequeno", "medio", "grande"],
    maxDogs: 6,
    availableSlots: ["manha", "tarde", "noite"],
    amenities: ["cercado", "agua", "agility"],
  ...
  },
  {
    ...
    spaceType: "quintal",
    allowedUses: ["treino", "socializacao", "brincadeira", "passeio"],
    dogSizes: ["pequeno", "medio", "grande"],
    maxDogs: 5,
    availableSlots: ["manha", "tarde"],
    amenities: ["cercado", "gramado", "agua", "agility"],
